...
def classify_upload():
    ...
    yolopred="/home/sai/darknet/predictions.png"
    #webbrowser.get('google-chrome').open_new_tab(yolopred)
    img_yolo = exifutil.open_oriented_im(yolopred)
    ...
    return flask.render_template(
        ...
        imagesrc=embed_image_html(image), predsrc=embed_image_pred(img_yolo))
